...
export function evidenceFor(locale: Locale) {
  const l = (ptVal: string, enVal: string, esVal: string) => (locale === "pt" ? ptVal : locale === "es" ? esVal : enVal);
  return [
  {
    kind: "fact", labelPt: "Situação legislativa", labelEn: "Legislative status", labelEs: "Situación legislativa", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "El Senado aprobó el REDATA, el PL 278/2026, el 1 de septiembre de 2026, y envió el texto a sanción presidencial. La tramitación pasó por el Plenario con 22 enmiendas presentadas.",
  ...
  {
    kind: "fact", labelPt: "Texto aprovado", labelEn: "Passed text", labelEs: "Texto aprobado", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "El texto de la Cámara prevé un 10% de oferta doméstica, pero mide el porcentaje por los ingresos. Permite la sustitución total por inversión adicional en I+D y reduce el compromiso al 8% en regiones incentivadas.",
  ...
  {
    kind: "fact", labelPt: "Fato observado", labelEn: "Observed fact", labelEs: "Hecho observado", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "La oferta interna de electricidad de Brasil llegó a 783,3 TWh en 2025, con un 86,8% de fuentes renovables.",
  ...
  },
  {
    ...
    claimEs: "La EPE registró 719 MW de carga total de data centers en Brasil en 2025. El número incluye telecomunicaciones, nube y procesamiento empresarial; no funciona como inventario de GPU.",
  ...
  },
  {
    ...
    claimEs: "La EPE propuso R$ 5,68 mil millones en nuevas instalaciones de transmisión para conectar hasta 4 GW de cargas electrointensivas en Ceará y Piauí.",
  ...
  {
    kind: "fact", labelPt: "Plano publicado", labelEn: "Published plan", labelEs: "Plan publicado", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "El PBIA prevé R$ 23,03 mil millones de inversión entre 2024 y 2028, con R$ 5,79 mil millones destinados a infraestructura y desarrollo de IA. Son valores planificados, no ejecutados: en septiembre de 2025, el 31% de las acciones estaban entregadas o iniciadas. El FNDCT pagó cerca del 28% de lo autorizado en 2024, pero el 100% de lo que se le liberó; la liberación total solo se permite a partir de 2027 (MP 1.136/2022), y la LC 177/2021 impide el contingenciamiento.",
  ...
  {
    kind: "fact", labelPt: "Síntese científica", labelEn: "Scientific assessment", labelEs: "Evaluación científica", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "El International AI Safety Report 2026 encuentra evidencia sólida del uso de IA por grupos criminales y actores estatales en operaciones cibernéticas. El informe también registra que aún no se han reportado ataques autónomos de extremo a extremo y que el efecto sobre la escala total de los ataques sigue siendo incierto.",
  ...
  {
    kind: "fact", labelPt: "Mecanismo internacional", labelEn: "International mechanism", labelEs: "Mecanismo internacional", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "La Asamblea General de la ONU creó un Diálogo Global sobre Gobernanza de la IA con la participación de los 193 Estados miembros. La primera sesión se realizó en julio de 2026 y la segunda está prevista para mayo de 2027.",
    source: "ONU, Diálogo Global sobre IA", url: "https://www.un.org/global-dialogue-ai-governance/en/faq", checked: "07/08/2026",
  },
  {
    kind: "fact", labelPt: "Polo institucional", labelEn: "Institutional pole", labelEs: "Polo institucional", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "Estados Unidos lanzó Pax Silica en diciembre de 2025 como una iniciativa para cadenas seguras de suministro de IA, semiconductores, computación y energía.",
  ...
  },
  {
    ...
    claimEs: "En julio de 2026, 29 países fundaron en Shanghái la Organización Mundial para la Cooperación en Inteligencia Artificial, la WAICO.",
  ...
  {
    kind: "fact", labelPt: "Precedente comercial", labelEn: "Trade precedent", labelEs: "Precedente comercial", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "En el caso DS472, la OMC consideró incompatibles con las reglas comerciales las medidas brasileñas que condicionaban beneficios tributarios a contenido y producción local, incluido el Inovar-Auto.",
    source: "OMC, caso DS472", url: "https://www.wto.org/english/tratop_e/dispu_e/cases_e/ds472_e.htm", checked: "28/08/2026",
  },
  {
    kind: "fact", labelPt: "Projeto reportado", labelEn: "Reported project", labelEs: "Proyecto reportado", confidencePt: "Média", confidenceEn: "Medium", confidenceEs: "Media",
    ...
    claimEs: "Reportajes describen una primera fase de cerca de 200 MW para el campus de ByteDance en Pecém, con la ambición de expandirse hacia cerca de 1 GW y un contrato eólico de veinte años.",
  ...
  {
    kind: "fact", labelPt: "Resposta regulatória", labelEn: "Regulatory response", labelEs: "Respuesta regulatoria", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "El CONAMA pidió directrices nacionales sobre consumo de agua y energía, emisiones, impactos territoriales, tarifas y participación pública en el licenciamiento de data centers.",
  ...
  {
    kind: "fact", labelPt: "Alegação do empreendedor", labelEn: "Developer claim", labelEs: "Afirmación del desarrollador", confidencePt: "Exige verificação", confidenceEn: "Verification required", confidenceEs: "Requiere verificación",
    ...
    claimEs: "ByteDance afirma que el proyecto de Pecém usará energía renovable y refrigeración con reúso de agua. La fuente, los límites, la reposición en sequías y las obligaciones auditables siguen siendo relevantes.",
  ...
  {
    kind: "estimate", labelPt: "Estimativa dos autores", labelEn: "Author estimate", labelEs: "Estimación de los autores", confidencePt: "Baixa", confidenceEn: "Low", confidenceEs: "Baja",
    ...
    claimEs: "La participación de Brasil en la computación relevante para la IA puede estar entre el 0,1% y el 0,5%. No existe un censo mundial comparable; el rango sirve como hipótesis de trabajo.",
    source: "Brasil 20XX, cálculo de trabalho", url: l("/evidencias#metodo", "/en/evidence#method", "/es/evidencias#metodo"), checked: "06/08/2026",
  },
  {
    kind: "fact", labelPt: "Precedente observado", labelEn: "Observed precedent", labelEs: "Precedente observado", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "La automatización bancaria brasileña redujo el empleo del sector de cerca de 750 mil (1990) a cerca de 390 mil (2000), una caída del 46% en diez años. Los escenarios usan ese ritmo, de cuatro a cinco puntos por año, como referencia para el empleo administrativo.",
  ...
  {
    kind: "fact", labelPt: "Precedente observado", labelEn: "Observed precedent", labelEs: "Precedente observado", confidencePt: "Média", confidenceEn: "Medium", confidenceEs: "Media",
    ...
    claimEs: "En Estados Unidos, el empleo relativo de los trabajadores de 22 a 25 años en ocupaciones más expuestas a la IA cayó un 13% entre finales de 2022 y julio de 2025, sin una caída equivalente para los más experimentados. El efecto aparece en las contrataciones de ingreso, no en el stock. Máximos de la serie brasileña: desocupación de 14,9% y 14,8 millones de desocupados en 2021.",
  ...
  },
  {
    ...
    claimEs: "La informalidad brasileña pasó de 41,1% en 2019 a 38,7% en 2020, durante el colapso agudo de la pandemia, y estaba en 38,1% en 2025. En recesiones lentas, como la de 2015 a 2017, sube; en colapsos agudos, baja, porque los puestos informales desaparecen primero. Desempleo récord e informalidad récord nunca coincidieron en la serie.",
  ...
  },
  {
    ...
    claimEs: "La recaudación federal cayó 5,6% en términos reales en 2015, 3,0% en 2016 y 6,9% en 2020. La renegociación de las deudas estatales llegó en 2017 (LC 159) y en 2025 (LC 212). Los escenarios usan ese rango de 3% a 7% al año como límite de una caída de ingresos plausible.",
  ...
  },
  {
    ...
    claimEs: "Estados Unidos y China firmaron en noviembre de 2024 una declaración sobre control humano de armas nucleares y solo anunciaron un canal bilateral oficial sobre IA militar y seguridad en mayo de 2026, con conversaciones previstas para septiembre. No hay texto vinculante.",
  ...
  },
  {
    ...
    claimEs: "El acuerdo más rápido entre superpotencias después de una crisis llevó de ocho a diez meses: de la crisis de Cuba (octubre de 1962) a la línea directa (junio de 1963) y al Tratado de Prohibición Parcial de Ensayos (agosto de 1963), pero tras ocho años de negociación previa. Las moratorias tecnológicas suelen durar de dos a tres años y terminan erosionadas; de los cinco casos conocidos, una se rompió en menos de dos años.",
  ...
  },
  {
    ...
    claimEs: "En el Tratado de No Proliferación, los proyectos idénticos de Estados Unidos y la Unión Soviética (agosto de 1967) no tenían artículos para los países no nucleares; las enmiendas de Brasil, México, India y Suecia produjeron los artículos de uso pacífico, desarme y revisión. Los terceros influyeron en las cláusulas de acceso y proceso, en un foro multilateral, no en los límites entre las potencias.",
  ...
  },
  {
    ...
    claimEs: "El gobierno publicó en agosto de 2026 una licitación de R$ 1 mil millones para una supercomputadora pública de 7.200 petaflops en el ámbito del PBIA. El Santos Dumont, ampliado en 2025, tiene 18,85 petaflops.",
  ...
  },
  {
    ...
    claimEs: "USA Rare Earth compró Serra Verde, mina de tierras raras pesadas en Minaçu (GO), en abril de 2026, por cerca de US$ 2,8 mil millones, con un contrato de compra de toda la producción de la fase 1 por quince años. La mina produce desde enero de 2024, cerca de 5 mil toneladas de óxidos por año, cerca del 2% de la oferta global; Brasil no tiene separación ni fabricación de imanes.",
  ...
  },
  {
    ...
    claimEs: "Pax Silica pasó de 7 signatarios en diciembre de 2025 a 25 en agosto de 2026; Brasil no está entre ellos. El American AI Exports Program (Federal Register, octubre de 2025; convocatoria de abril de 2026) excluye a las empresas y la tecnología de China de todas las capas de los paquetes de exportación que financia.",
  ...
  },
  {
    ...
    claimEs: "De la exigencia estadounidense al desenlace: G42 (Emiratos) cerca de nueve meses para retirar el equipo Huawei y recibir la inversión de Microsoft (abril de 2024); Reino Unido de 18 a 30 meses para prohibir a Huawei en el 5G (julio de 2020); Malasia cuatro meses hasta los controles de reexportación (2025). Brasil resistió en el 5G en 2021 sin vetar a Huawei, creando una red privativa para el gobierno separada de la red comercial.",
  ...
  },
  {
    ...
    claimEs: "Ningún socio de Estados Unidos obtuvo acceso a chips o licencias de IA en 2024–2026 sin aceptar la exclusión de hardware chino: Emiratos (asociación de mayo de 2025, licencias en noviembre), Arabia Saudita, Malasia. Vietnam mantiene relaciones tecnológicas con ambos bloques desde hace seis a diez años, con exposición difusa en muchas empresas y a Huawei fuera del 5G.",
  ...
  },
  {
    ...
    claimEs: "La ANPD tardó desde 2018 (LGPD) hasta noviembre de 2020 en comenzar a operar y hasta 2026 en convertirse en agencia con autonomía (Ley 15.352); funcionó con personal íntegramente requisado, la división de fiscalización llegó a tener cinco servidores y el concurso para una carrera propia aún estaba en preparación en 2026. De la ley al plantel propio, de cinco a ocho años.",
  ...
  },
  {
    ...
    claimEs: "Los institutos de evaluación de seguridad de IA sin poder regulatorio comenzaron a operar en menos de un año: el del Reino Unido, anunciado en noviembre de 2023, publicaba evaluaciones en 2024; el de Japón fue creado en febrero de 2024. El acceso a los modelos llegó mediante acuerdos voluntarios con los laboratorios, no por ley.",
    source: "UK AI Security Institute", url: "https://www.aisi.gov.uk/", checked: "02/09/2026",
  },
  {
    kind: "fact", labelPt: "Precedente regulatório", labelEn: "Regulatory precedent", labelEs: "Precedente regulatorio", confidencePt: "Alta", confidenceEn: "High", confidenceEs: "Alta",
    ...
    claimEs: "El régimen estadounidense de difusión de 2025 creó tiers para chips, pesos y entrenamiento. El texto no creó tiers para las API comunes de inferencia.",
  ...
  {
    kind: "scenario", labelPt: "Invenção narrativa", labelEn: "Narrative invention", labelEs: "Invención narrativa", confidencePt: "Não se aplica", confidenceEn: "Not applicable", confidenceEs: "No aplica",
    ...
    claimEs: "Camila convierte las dudas de Lourdes sobre el REDATA en una nota para el diputado durante el esfuerzo concentrado de agosto de 2026.",
    source: l("Cena de 2026", "2026 scene", "Escena de 2026"), url: l("/#2026-um-assunto-para-depois-da-eleição", "/en#2026-the-branching-point", "/es#2026-un-asunto-para-después-de-la-elección"), checked: "27/08/2026",
  },
  {
    kind: "scenario", labelPt: "Invenção narrativa", labelEn: "Narrative invention", labelEs: "Invención narrativa", confidencePt: "Não se aplica", confidenceEn: "Not applicable", confidenceEs: "No aplica",
    ...
    claimEs: "En el escenario, Estados Unidos y China cierran un acuerdo de desaceleración en 2028 que preserva su ventaja y no garantiza capacidad a Brasil.",
    source: l("Cenário", "Negative scenario", "Escenario negativo"), url: l("/#2028-o-acordo-dos-outros", "/en#2028-someone-elses-agreement", "/es#2028-el-acuerdo-de-los-otros"), checked: "28/08/2026",
  },
  {
    kind: "scenario", labelPt: "Invenção narrativa", labelEn: "Narrative invention", labelEs: "Invención narrativa", confidencePt: "Não se aplica", confidenceEn: "Not applicable", confidenceEs: "No aplica",
    ...
    claimEs: "Las empresas brasileñas intercambian datos operativos por ciberdefensa extranjera tras una ola de ransomware en 2027.",
    source: l("Cenário", "Negative scenario", "Escenario negativo"), url: l("/#2027-a-segunda-feira-sem-sistema", "/en#2027-attacks-layoffs-and-emergency-powers", "/es#2027-el-lunes-sin-sistema"), checked: "28/08/2026",
  },
  {
    kind: "scenario", labelPt: "Invenção narrativa", labelEn: "Narrative invention", labelEs: "Invención narrativa", confidencePt: "Não se aplica", confidenceEn: "Not applicable", confidenceEs: "No aplica",
    ...
    claimEs: "En el escenario, Brasil acepta condiciones políticas para garantizar computación, crédito y defensa digital en 2029.",
    source: l("Cenário", "Negative scenario", "Escenario negativo"), url: l("/#2029-acesso-em-troca-de-alinhamento", "/en#2029-access-in-exchange-for-alignment", "/es#2029-acceso-a-cambio-de-alineamiento"), checked: "28/08/2026",
  },
  {
    kind: "scenario", labelPt: "Invenção narrativa", labelEn: "Narrative invention", labelEs: "Invención narrativa", confidencePt: "Não se aplica", confidenceEn: "Not applicable", confidenceEs: "No aplica",
    ...
    claimEs: "El escenario proyecta el mayor número de desocupados de la serie histórica, fuga de talentos y la transformación de Brasil en un régimen híbrido hacia 2030.",
    source: l("Cenário", "Negative scenario", "Escenario negativo"), url: l("/#2030-país-satélite", "/en#2030-satellite-country", "/es#2030-país-satélite"), checked: "28/08/2026",
  },
  {
    kind: "open", labelPt: "Proposta em aberto", labelEn: "Open proposal", labelEs: "Propuesta abierta", confidencePt: "Aberta", confidenceEn: "Open", confidenceEs: "Abierta",
    ...
    claimEs: "Una desaceleración verificable exigiría umbrales de capacidad, evaluaciones compartidas, comunicación de incidentes y condiciones para reanudar el entrenamiento o la implantación. El proyecto aún necesita definir esos mecanismos.",
    source: l("Agenda de trabalho", "Working agenda", "Agenda de trabajo"), url: l("/estrategia", "/en/strategy", "/es/estrategia"), checked: "07/08/2026",
  },
  {
    kind: "open", labelPt: "Em modelagem", labelEn: "Model pending", labelEs: "En modelado", confidencePt: "Aberta", confidenceEn: "Open", confidenceEs: "Abierta",
    ...
    claimEs: "Capacidad brasileña en 2030, parcela contratable y costo por trayectoria. Pedro todavía está construyendo el modelo.",
    source: l("Modelo de Pedro", "Pedro's model", "Modelo de Pedro"), url: l("/evidencias#lacunas", "/en/evidence#open-gaps", "/es/evidencias#brechas"), checked: "06/08/2026",
  },
  ];
}
