...
const combinedScenarioEn = "# Brazil 2030 — scenario\n\n**Translation in progress.** The scenario was substantially rewritten in September 2026 and the English edition is being retranslated from scratch. The previous English text has been withdrawn rather than left to describe a version that no longer exists. The Portuguese scenario is current.\n";
