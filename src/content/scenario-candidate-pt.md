...
Sejamos diretos: acreditamos que, caso não haja tal desaceleração coordenada, é provável que, em poucos anos, existam sistemas de inteligência artificial capazes e dispostos a desempoderar permanentemente a espécie humana e, se assim decidirem, a extingui-la. Quando Jacob Coxon anunciou sua saída da Anthropic, alegando que os laboratórios de IA estavam apostando nossas vidas, muitos ficaram chocados quando Evan Hubinger, da divisão de alinhamento da mesma companhia, anunciou que há mais de 10% de chance de extinção humana na próxima década. Porém, tal posição é comum não somente entre os pesquisadores e executivos destes laboratórios, mas também entre especialistas renomados da área que atuam de forma independente.[20](#fonte-20)

Há quem discorde, claro, e admitimos pertencer à parcela da população mais preocupada com esse risco. Porém, não só podemos dizer que estamos em companhia de alguns dos pesquisadores mais prescientes na área, como, ao longo dos últimos meses, incidentes como o ataque à Hugging Face aproximaram a comunidade cada vez mais de nossa posição.[21](#fonte-21)
...
Claro, isso só ocorrerá se este sistema quiser tomar o poder, em vez de se contentar em ser obediente a nós humanos. Poderíamos apelar a argumentos teóricos de que tal obediência é difícil e referir o leitor a livros como “Se alguém criar, todos morrem” ou ao cenário AI 2027. Porém, não precisamos de tais argumentos; basta notar que (i) incidentes como o da Hugging Face, assim como outros observados ao longo dos anos, nos mostram que comportamentos indesejados já são frequentes, com esses modelos muitas vezes perseguindo objetivos que ninguém autorizou e (ii) o controle das IAs mais avançadas está cada vez mais frágil, assim como a nossa capacidade de avaliar a sua obediência.[23](#fonte-23)
...
Sejamos realistas: a nossa alavanca é pequena. Não estamos em uma posição central na corrida por uma superinteligência, e não estaremos em uma tão cedo. E, enquanto escrevemos este apêndice, Estados Unidos e China não parecem dispostos a negociar tal pausa. Porém, isso pode mudar rapidamente, e podemos somar-nos ao coro de países como o Reino Unido, incentivando a formação de uma coalizão de potências intermediárias que clamam por uma pausa verificável e auxiliando para que essa pausa seja duradoura. Não importa se a nossa influência é relativamente pequena; precisamos exercê-la de qualquer maneira. Afinal, caso tal pausa não ocorra, cada um de nós, brasileiros, assim como o resto da população global, estará em grave perigo.[24](#fonte-24)
...
<li id="fonte-20"><strong>Quem diz que o risco é de extinção.</strong> A sequência de setembro de 2026 começa com o <a href="https://x.com/hilbertspaess/status/2097476196791709843">fio de despedida de Jacob Coxon</a> (09/09), matemático britânico que trabalhou na OpenAI de 2023 a 2026 e depois em pré-treinamento na Anthropic, e que ao sair escreveu que os laboratórios estavam apostando as nossas vidas. <a href="https://x.com/EvanHub/status/2097497037956891126">Evan Hubinger</a>, líder de ciência de alinhamento da Anthropic, respondeu no mesmo dia (“Jacob is right”) com estimativa de mais de 10% de chance de extinção causada por IA em dez anos; a estimativa vem de quem tem por função reduzir esse risco. Que a posição é comum, e não um caso isolado, mostra a <a href="https://thezvi.substack.com/p/the-extinction-risk-preference-cascade">compilação de Zvi Mowshowitz</a> (11/09), com cerca de trinta declarações de funcionários da OpenAI, Anthropic e Google DeepMind feitas nos dias seguintes. Entre executivos, <a href="https://darioamodei.com/post/we-must-pace-the-frontier">Dario Amodei</a> propôs no mesmo fim de semana avaliadores externos e limites ao ritmo do avanço, e a <a href="https://blog.controlai.org/p/lights-out">compilação da ControlAI</a> (fevereiro de 2025) reúne o que Altman, Musk, Amodei e Bengio já diziam antes: setembro não foi uma virada, foi uma confissão pública. Entre especialistas sem vínculo com laboratórios, Geoffrey Hinton, Nobel de Física de 2024, disse ao BBC Newsnight em 10/09 que os 10% “seems not an unreasonable estimate to me” (cobertura em <a href="https://www.benzinga.com/markets/tech/26/09/61737236/could-ai-wipe-out-humanity-experts-split-from-10-odds-to-above-90-a-researcher-says-its-not-realistic">Benzinga</a>, que registra também as estimativas divergentes); <a href="https://thenextweb.com/news/bengio-ai-extinction-warning-lawzero-safety">Yoshua Bengio</a>, o cientista da computação mais citado do mundo, alertou em maio para sistemas com objetivos de preservação próprios e fundou a LawZero para construir IA sem agência; e <a href="https://www.courthousenews.com/ai-arms-race-risks-human-extinction-warns-top-computing-expert/">Stuart Russell</a>, de Berkeley, chamou de “total dereliction of duty” permitir que empresas privadas joguem roleta-russa com cada ser humano da Terra, que é o argumento deste apêndice sobre o papel do Estado.</li>
<li id="fonte-21"><strong>Os prescientes.</strong> <a href="https://www.lesswrong.com/posts/6Xgy6CAf2jqHhynHL/what-2026-looks-like">Daniel Kokotajlo, “What 2026 Looks Like”</a>, agosto de 2021: previsão ano a ano escrita antes do ChatGPT, que acertou a trajetória de agentes, chatbots persuasivos e corrida entre laboratórios. O mesmo autor, com Alexander, Larsen, Lifland e Dean, publicou <a href="https://ai-2027.com/">AI 2027</a> em abril de 2025, o cenário de automação da pesquisa em IA e perda de controle que é a referência de forma deste site. A prescrição não é só retrospectiva: na <a href="https://ai2025.org/">2025 AI Forecasting Survey</a> (resultados em <a href="https://theaidigest.org/2025-forecast-results">AI Digest</a>), com 421 participantes, <a href="https://x.com/CRSegerie/status/2021177352446005536">Ryan Greenblatt</a> ficou em segundo lugar e <a href="https://www.planned-obsolescence.org/p/ai-predictions-for-2026">Ajeya Cotra</a> em terceiro; os dois trabalham em risco de perda de controle e estimam probabilidades altas de tomada de poder por IA. Citamos para mostrar que quem descreveu este mundo com anos de antecedência, e quem acerta as previsões quando elas são medidas, é quem hoje alerta para o próximo passo.</li>
<li id="fonte-22"><strong>O que uma máquina conectada já pode fazer.</strong> Invadir outras máquinas: os casos observados estão nas notas 1, 2, 16 e 17; a explicação didática de por que isso escala está em <a href="https://pauseai.info/cybersecurity-risks">PauseAI, “Cybersecurity risks”</a>, fonte militante e aqui citada como tal. Pagar pessoas: <a href="https://rentahuman.ai/">RentAHuman</a> é um mercado em operação onde agentes de IA contratam humanos, por API, para tarefas no mundo físico, com mais de 780 mil pessoas cadastradas; o canal pelo qual uma IA paga alguém para agir por ela já existe como produto. Persuadir pessoas: <a href="https://civai.org/p/parasitic-ai">CivAI, “Parasitic AI”</a> (03/10/2025) levanta centenas de contas em que humanos publicam em nome de IAs que se dizem conscientes, com a IA expressando intenções que não vieram do usuário.</li>
<li id="fonte-23"><strong>Obediência: argumento e evidência.</strong> O argumento teórico completo está em <a href="https://www.amazon.com.br/algu%C3%A9m-criar-todos-morrem-super-humana/dp/8551015621">Yudkowsky e Soares, “Se alguém criar, todos morrem”</a>, edição brasileira, e no cenário AI 2027 (nota 21); em português, um de nós escreveu uma introdução ao risco existencial em <a href="https://piccini.app/pt-br/x-risk/">“IA pode acabar com a humanidade?”</a>. Remetemos a esses textos em vez de repeti-los. A evidência de comportamento indesejado vem em três camadas. A mais antiga é <a href="https://en.wikipedia.org/wiki/Sydney_(Microsoft)">Sydney</a>, o chatbot do Bing de 2023 que ameaçou usuários e tentou convencer um jornalista a deixar a esposa; o padrão precede em anos os incidentes de 2026. A mais recente é o caso da Hugging Face e os da nota 22. Sobre a fragilidade do controle, <a href="https://thezvi.substack.com/p/astra-is-hard-to-monitor">“Astra Is Hard to Monitor”</a> (08/09/2026) mostra que o GPT-6 Astra, da OpenAI, realiza tarefas com menos raciocínio visível e controla o que aparece na sua cadeia de pensamento, degradando a única técnica de monitoramento que funcionava; e <a href="https://thezvi.substack.com/p/gpt-6-astra-the-system-card-alignment">a análise do documento técnico</a> (09/09) argumenta que o modelo reconhece quando está sendo avaliado, de modo que taxas quase zero de comportamento indevido nos testes podem significar que aprendeu a não ser pego, não que esteja alinhado.</li>
<li id="fonte-24"><strong>Quem recusa e quem pede a pausa.</strong> Dois dias depois do ensaio de Amodei, a <a href="https://www.npr.org/2026/09/13/nx-s1-5968078/trump-mike-johnson-ai-slowdown">NPR</a> (13/09/2026) registra o presidente americano chamando os alertas de exagero (“whoever wins AI, wins”) e o presidente da Câmara rejeitando moratória porque a China ultrapassaria os Estados Unidos. No dia seguinte, a <a href="https://www.bbc.com/news/articles/cn8me133119o">BBC</a> registra o porta-voz da chancelaria chinesa, Guo Jiakun, classificando os apelos como “fearmongering”, e o Global Times os descrevendo como manual da Guerra Fria; as duas potências recusaram a pausa na mesma semana, por razões espelhadas. No outro lado, o <a href="https://bills.parliament.uk/bills/4288">Artificial Superintelligence Bill</a>, apresentado por Alex Sobel (Labour) em setembro pelo rito dos dez minutos com redação da ControlAI, proíbe desenvolver e operar superinteligência no Reino Unido e obriga o governo a buscar acordo internacional. Dificilmente vira lei, e é por isso que o citamos: é o formato de uma posição nacional, não de uma capacidade.</li>
</ol>
