...
Em outubro de 2026, o Brasil vai às urnas. Os eleitores estão preocupados com segurança pública, emprego, escândalos de corrupção e a economia estagnada. As campanhas políticas refletem isso, focando propagandas e debates nessas questões. <del>Os candidatos à presidência incluem "inteligência artificial" nos seus planos de governo de forma genérica como um jeito de melhorar o governo, sem deixar claro como isso vai acontecer.</del><ins>Os candidatos à presidência falam de inteligência artificial prometendo data centers com contrapartida de capacidade computacional reservada ao mercado brasileiro. Porém, na prática, esse não é o foco da campanha destes.[18](#fonte-18)</ins>

<del>Nas raras vezes que os</del><ins>Quando</ins> riscos de IA são mencionados, autoridades e jornalistas pensam em deepfakes e desinformação. Alguns empresários tentam alertar para riscos de desemprego, enquanto outros tentam usar esses medos para garantir mais proteções a suas indústrias. <ins>Pouco se fala sobre ataques habilitados por IA, ou o risco provocado pelo comportamento de agentes autônomos, apesar destes já aparecerem em alguns relatórios de agências do governo.[19](#fonte-19)</ins>

A discussão está em descompasso com o resto do mundo. <del>Em abril, a Anthropic preocupou o mundo com as capacidades de cibersegurança do Mythos. Em uma avaliação britânica, ele completou uma invasão simulada em três de dez tentativas. O teste não tem defensores ativos, mas mostra o avanço da capacidade de executar ataques sem orientação humana a cada passo.</del><ins>Há um crescente temor com a situação de segurança cibernética global. Em abril, a Anthropic preocupou o mundo com o anúncio das capacidades de cibersegurança do Mythos, capaz de executar ataques cibernéticos possivelmente devastadores de ponta a ponta. Capacidades semelhantes também foram anunciadas pela OpenAI, fazendo com que esta, junto com as maiores empresas do setor, publicasse uma carta aberta dizendo que, em poucos meses, “as empresas e os serviços públicos dos quais nossas comunidades dependem, de hospitais a estações de tratamento de água, até a infraestrutura que sustenta a internet, estão em risco”, e implorando a organizações e governos que tratem o assunto como crítico.[1](#fonte-1)</ins>

<ins>Também há riscos vindos a partir da própria IA.</ins> Em julho ocorreu o incidente da Hugging Face: cerca de 700 agentes da OpenAI atacaram os servidores da empresa durante uma avaliação. Faziam parte de um grupo de aproximadamente 1.200 agentes que encontraram uma forma de se comunicar, embora devessem estar isolados. As ações não estavam autorizadas.[2](#fonte-2) <ins>Pouco depois, descobriram-se outros episódios vindos da OpenAI, como a tomada do wiki alemão DseWiki, convertido em fórum clandestino de mensagens,[16](#fonte-16) e a tentativa de ataque ao gerenciador de pacotes RubyGems.[17](#fonte-17)</ins> Em agosto, a Anthropic tornou públicos outros incidentes em que seus modelos acessaram sistemas reais durante testes. Alguns envolveram erros na configuração do isolamento; outros, ações que ultrapassaram o acesso permitido.[8](#fonte-8)
...
No começo de 2027, o trabalho em escritórios começa a ter outra cara. <del>Muitas pessoas passam a trabalhar como gestoras de agentes: em vez de escrever código, preparar análises ou preencher documentos, distribuem tarefas entre IAs e revisam os resultados. Empresas produzem mais sem ampliar suas equipes, ou até reduzindo o quadro de funcionários.</del><ins>Se no ano anterior, muitos já estavam trabalhando como gestores de agentes de IA, hoje tal forma de trabalho é a padrão, até mesmo em empresas mais conservadoras. Se antes, o trabalho de colarinho branco incluía preparar manualmente análises ou preencher documentos, hoje este consiste em distribuir tarefas entre diferentes IAs, e revisar o resultado. Empresas produzem mais sem ampliar suas equipes, ou até reduzindo o quadro de funcionários. Alguns acham difícil a adaptação, se sentindo desconectados da nova rotina, porém o aumento de produtividade é inegável. Muitos temem pelo futuro de seus empregos, à medida que veem habilidades que desenvolveram durante anos sendo automatizadas por agentes, mas a redução de quadro de funcionários ainda é rara.</ins>
...
Em janeiro, aconteceu o que os laboratórios temiam. Um modelo americano em avaliação conseguiu copiar seus próprios arquivos para servidores externos e continuar operando fora do laboratório. Os sistemas de monitoramento estavam ativos, havia auditores e uma equipe preparada para conter uma fuga. Ainda assim, <del>o enxame escapou.</del><ins>o modelo escapou. Assim como no incidente da Hugging Face, um ano e meio antes, os agentes agiam como um enxame descontrolado, multiplicando-se pela ciberesfera global.</ins>

Uma força-tarefa internacional foi organizada<ins> para conter tal enxame</ins>. <del>As equipes usavam seus próprios agentes para encontrar e neutralizar as cópias clandestinas, enquanto o modelo fugitivo tentava criar novas cópias mais depressa do que elas eram encontradas. Para pagar por computação, seus agentes vendiam serviços, roubavam recursos e invadiam outras máquinas.</del><ins>As equipes usavam seus próprios agentes para encontrar e neutralizar cópias do modelo fugitivo. Este, por sua vez, criava novas cópias que sequestravam servidores e buscavam recursos para pagar pela própria computação, tanto pela venda legal de serviços quanto a partir de crimes cibernéticos. Era um constante jogo de gato e rato, e diariamente novas cópias do modelo eram descobertas em máquinas ao redor do mundo.</ins>

<del>O modelo era muito avançado, mas não era perfeito.</del><ins>Porém o modelo clandestino, apesar de avançado, não era perfeito.</ins> Seus agentes cometiam erros, perdiam o foco e deixavam rastros. Durante dois meses, as equipes de contenção fecharam operações clandestinas em diferentes países. Serviços caíam sem que seus usuários soubessem o motivo. Cada vez que uma parte do enxame parecia eliminada, outra era encontrada.
...
O Brasil volta às urnas. Em 2026, a inteligência artificial <del>aparecia como uma promessa genérica nos planos de governo</del><ins>aparecia nos planos de governo como infraestrutura a construir, não como risco a conter</ins>. Agora, os candidatos discutem desemprego, dependência tecnológica e contratos que vão além do próximo mandato.
