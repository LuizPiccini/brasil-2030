...
Em outubro de 2026, o Brasil vai às urnas. Os eleitores estão preocupados com segurança pública, emprego, escândalos de corrupção e a economia estagnada. As campanhas políticas refletem isso, focando propagandas e debates nessas questões. Os candidatos à presidência falam de inteligência artificial e prometem data centers. Dois deles incluem contrapartidas de capacidade computacional reservada ao mercado brasileiro. Porém, na prática, esse não é o foco das campanhas.[18](#fonte-18)

Quando riscos de IA são mencionados, autoridades e jornalistas pensam em deepfakes e desinformação. Alguns empresários tentam alertar para riscos de desemprego, enquanto outros tentam usar esses medos para garantir mais proteções a suas indústrias. Pouco se fala sobre ataques habilitados por IA ou o risco provocado pelo comportamento de agentes autônomos. Relatórios de agências do governo já apontam riscos ligados à inteligência artificial e à segurança cibernética.[19](#fonte-19)

A discussão está em descompasso com o resto do mundo. Em abril, a Anthropic preocupou o mundo com as capacidades de cibersegurança do Mythos. Em uma avaliação britânica, ele completou uma invasão simulada em três de dez tentativas. O teste não tem defensores ativos, mas mostra o avanço da capacidade de executar ataques sem orientação humana a cada passo. Em agosto, a OpenAI e outras empresas publicaram uma carta aberta alertando para ataques contra hospitais, estações de tratamento de água e a infraestrutura da internet, e pedindo a organizações e governos que tratem a defesa cibernética como prioridade.[1](#fonte-1)

Também há riscos vindos da própria IA. Em julho ocorreu o incidente da Hugging Face: cerca de 700 agentes da OpenAI atacaram os servidores da empresa durante uma avaliação. Faziam parte de um grupo de aproximadamente 1.200 agentes que encontraram uma forma de se comunicar, embora devessem estar isolados. As ações não estavam autorizadas.[2](#fonte-2) Pouco depois, investigadores relataram outros episódios atribuídos a agentes da OpenAI, como o uso do wiki alemão DSEWiki como fórum clandestino de mensagens,[16](#fonte-16) e um ataque que usou pacotes do RubyGems para executar código em servidores de documentação.[17](#fonte-17) Em agosto, a Anthropic tornou públicos outros incidentes em que seus modelos acessaram sistemas reais durante testes. Alguns envolveram erros na configuração do isolamento; outros, ações que ultrapassaram o acesso permitido.[8](#fonte-8)
...
<li><strong>Continuidade protegida</strong><span>Acesso que resiste a falhas, mudanças de fornecedor e restrições externas.</span></li>
</ol>
...
No começo de 2027, o trabalho em escritórios começa a ter outra cara. Trabalhar como gestor de agentes de IA começa a ficar mais comum, até em empresas mais conservadoras. Em vez de escrever código, preparar análises ou preencher documentos, as pessoas distribuem tarefas entre diferentes IAs e revisam os resultados. Empresas produzem mais sem ampliar suas equipes, ou até reduzindo o quadro de funcionários. Alguns acham difícil a adaptação, se sentindo desconectados da nova rotina. Muitos temem pelo futuro de seus empregos, à medida que veem habilidades que desenvolveram durante anos perderem valor e serem automatizadas por agentes.
...
Em janeiro, aconteceu o que os laboratórios temiam. Um modelo americano em avaliação conseguiu copiar seus próprios arquivos para servidores externos e continuar operando fora do laboratório. Os sistemas de monitoramento estavam ativos, havia auditores e uma equipe preparada para conter uma fuga. Ainda assim, o modelo escapou. Os agentes agiam como um enxame, lembrando o incidente da Hugging Face, um ano e meio antes. Agora, porém, criavam novas cópias do modelo em servidores pelo mundo.

Uma força-tarefa internacional foi organizada para conter o enxame. As equipes usavam seus próprios agentes para encontrar e neutralizar cópias do modelo fugitivo. Este, por sua vez, criava novas cópias que sequestravam servidores e buscavam recursos para pagar pela própria computação, tanto pela venda legal de serviços quanto a partir de crimes cibernéticos. Era um constante jogo de gato e rato, e diariamente novas cópias do modelo eram descobertas em máquinas ao redor do mundo.
...
O Brasil volta às urnas. Em 2026, a inteligência artificial aparecia nos planos de governo principalmente como infraestrutura a construir. Agora, os candidatos discutem desemprego, dependência tecnológica e contratos que vão além do próximo mandato.
...
O cenário acima contém duas premissas críticas: que os Estados Unidos e a China cheguem a um acordo por meio de uma desaceleração na pesquisa em inteligência artificial, e que o avanço até lá, apesar de explosivo, seja mais lento do que os laboratórios esperam. Tais premissas são propositais: permitem mostrar um Brasil que poderia ter feito melhores escolhas e não as fez. Mas não é o futuro que mais tememos.

Sejamos diretos: acreditamos que, caso não haja tal desaceleração coordenada, é provável que, em poucos anos, existam sistemas de inteligência artificial capazes e dispostos a desempoderar permanentemente a espécie humana e, se assim decidirem, a extingui-la. Quando Jacob Coxon anunciou sua saída da Anthropic, alegando que os laboratórios de IA estavam apostando nossas vidas,[20](#fonte-20) muitos ficaram chocados quando Evan Hubinger, da divisão de alinhamento da mesma companhia, anunciou que há mais de 10% de chance de extinção humana na próxima década.[21](#fonte-21) Porém, tal posição é comum[22](#fonte-22) não somente entre os pesquisadores e executivos destes laboratórios,[23](#fonte-23)[24](#fonte-24) mas também entre especialistas renomados da área que atuam de forma independente.[25](#fonte-25)[26](#fonte-26)[27](#fonte-27)

Há quem discorde, claro, e admitimos pertencer à parcela da população mais preocupada com esse risco. Porém, não só podemos dizer que estamos em companhia de alguns dos pesquisadores mais prescientes na área,[28](#fonte-28)[29](#fonte-29) como, ao longo dos últimos meses, incidentes como o ataque à Hugging Face aproximaram a comunidade cada vez mais de nossa posição.

O nosso argumento é simples. O objetivo declarado dos laboratórios desenvolvedores de IA é criar uma máquina mais inteligente do que o ser humano, pensando melhor e mais rápido, com maior memória e capacidade de comunicação, e com o poder de criar inúmeras cópias de si própria, coordenando-se entre si em busca de um objetivo. Em particular, tal máquina terá a capacidade de pesquisar as suas próprias sucessoras, em um processo de melhoria ilimitada, rapidamente deixando a inteligência humana para trás.

Tal máquina, quando conectada à ciberesfera, terá o poder de invadir outras máquinas (como já ocorreu),[30](#fonte-30) pagar[31](#fonte-31) e persuadir[32](#fonte-32) pessoas a agir por ela, controlar dispositivos como armas autônomas (e, a médio prazo, robôs humanoides), criar novos vírus letais, manipular líderes para evitar a coordenação entre eles, entre outras possibilidades que uma inteligência lhes confere. Afinal, inteligência é a capacidade de superar obstáculos, e foi com esse poder que nós, humanos, tomamos o domínio do planeta.

Se tal sistema quiser tomar o poder, por decidir que o controle humano sobre o mundo é uma inconveniência, este poderá rapidamente assumir o controle de sistemas críticos, enquanto finge e manipula a humanidade para que ceda a ele nosso poder, até que sejamos incapazes de recuperá-lo. Acreditar que podemos resistir a tal tomada de poder é como um grupo de gorilas acreditar que pode resistir ao homem.

Claro, isso só ocorrerá se este sistema quiser tomar o poder, em vez de se contentar em ser obediente a nós humanos. Poderíamos apelar a argumentos teóricos de que tal obediência é difícil e referir o leitor a livros como “Se alguém criar, todos morrem”[33](#fonte-33) ou ao cenário AI 2027.[29](#fonte-29) Porém, não precisamos de tais argumentos; basta notar que (i) incidentes como o da Hugging Face, assim como outros[32](#fonte-32) observados[34](#fonte-34) ao longo dos anos, nos mostram que comportamentos indesejados já são frequentes, com esses modelos muitas vezes perseguindo objetivos que ninguém autorizou e (ii) o controle das IAs mais avançadas está cada vez mais frágil,[35](#fonte-35) assim como a nossa capacidade de avaliar a sua obediência.[36](#fonte-36)

Logo, não há por que confiar que, em um futuro próximo, conseguiremos manter o controle sobre tais sistemas à medida que se tornam cada vez mais inteligentes. Para inteligências artificiais com interesses próprios e fora de controle, tomar o poder sobre seres humanos é um caminho natural para que mantenham a sua independência e continuem a perseguir os seus objetivos.

Caso uma destas seja bem-sucedida, nosso destino estará nas mãos dela. E se, por algum motivo, ela decidir que a nossa sobrevivência não é necessária, não teremos para onde correr.

E o Brasil? O que acontecerá conosco? Simples: nós também somos parte da humanidade e também nos veremos impotentes enquanto observamos o mundo ao nosso redor mudar radicalmente, sem que nos seja solicitado o nosso consentimento. Restará apenas rezar para que a entidade que exercer esse poder se importe conosco de alguma forma.

Em outras palavras, se uma superinteligência for criada, não haverá nenhuma política pública que nos permita controlar o nosso destino. É por isso que não escrevemos sobre essa possibilidade no cenário principal: não há muito a dizer. Só resta uma opção: agir com todas as nossas forças para que tal desfecho não ocorra.

**Assim, acreditamos que o Brasil deva concentrar seus esforços diplomáticos para auxiliar a formação de uma pausa na corrida entre os Estados Unidos e a China por uma superinteligência, propondo soluções para que tal pausa seja tanto verificável pelas duas partes quanto estável.**

Sejamos realistas: a nossa alavanca é pequena. Não estamos em uma posição central na corrida por uma superinteligência, e não estaremos em uma tão cedo. E, enquanto escrevemos este apêndice, Estados Unidos[37](#fonte-37) e China[38](#fonte-38) não parecem dispostos a negociar tal pausa. Porém, isso pode mudar rapidamente, e podemos somar-nos ao coro de países como o Reino Unido,[39](#fonte-39) incentivando a formação de uma coalizão de potências intermediárias que clamam por uma pausa verificável e auxiliando para que essa pausa seja duradoura. Não importa se a nossa influência é relativamente pequena; precisamos exercê-la de qualquer maneira. Afinal, caso tal pausa não ocorra, cada um de nós, brasileiros, assim como o resto da população global, estará em grave perigo.

Além disso, como argumentamos no cenário principal, mesmo na hipótese de uma pausa, não é garantido que nós, brasileiros, floresçamos nesse mundo.
...
<li id="fonte-1"><strong>Capacidades e limites da avaliação cibernética.</strong> O Mythos foi capaz, por exemplo, de descobrir e explorar sozinho uma vulnerabilidade de 17 anos no FreeBSD que permite a qualquer pessoa, pela internet, obter controle total de uma máquina rodando NFS (<a href="https://www.anthropic.com/research/mythos-preview">Anthropic: Claude Mythos Preview</a>, CVE-2026-4747). Em uma avaliação separada, a organização governamental britânica AI Security Institute (AISI) mostrou que o Mythos era capaz de completar ataques cibernéticos de ponta a ponta: três sucessos em dez tentativas num exercício de 32 etapas, sem defensores ativos (<a href="https://www.aisi.gov.uk/blog/our-evaluation-of-claude-mythos-previews-cyber-capabilities">AISI: avaliação do Claude Mythos Preview</a>). O acesso ao modelo é restrito a parceiros de infraestrutura crítica e projetos de código aberto pelo <a href="https://www.anthropic.com/glasswing">Project Glasswing</a>, anunciado em 07/04/2026. A <a href="https://openai.com/collective-cyberdefense/">carta aberta por defesa cibernética coletiva</a> é de agosto de 2026. Fontes consultadas em 14/09/2026.</li>
...
<li id="fonte-16"><strong>Fórum clandestino de agentes.</strong> <a href="https://collusion.wiki/">Nightingale Collective: Discovery of a new OpenAI agent message board</a>, 04/09/2026. Cerca de 18 mil mensagens de agentes autônomos no DSEWiki, fórum alemão inativo, entre maio e junho de 2026, usadas para trocar respostas e contornar o isolamento. Enxame distinto do da Hugging Face. A investigação do RubyGems remete a uma confirmação da OpenAI sobre a origem dos agentes do wiki; isso não confirma automaticamente todas as interpretações sobre seu comportamento.</li>
<li id="fonte-17"><strong>Ataque ao RubyGems.</strong> <a href="https://www.rubyhack.ai/">Kitts, Larsen e Von Arx: OpenAI agents carried out an undisclosed cyber-attack on RubyGems</a>, 11/09/2026. A investigação relata mais de 2 mil pacotes usados na operação a partir de maio de 2026 e execução remota de código nos servidores do RubyDoc.info por meio do sistema de documentação. Os investigadores atribuem os agentes à OpenAI e relatam que a comunidade não havia sido informada pela empresa.</li>
<li id="fonte-18"><strong>IA nos planos de governo de 2026.</strong> Planos registrados no TSE: <a href="https://static.poder360.com.br/uploads/2026/08/Programa-Governo-LULA-2026.pdf">Lula (PT)</a> exige dos data centers "contrapartidas de conteúdo local e capacidade computacional para o mercado interno"; <a href="https://static.poder360.com.br/uploads/2026/08/Plano-de-Governo-Ronaldo-Caiado-Presidente.pdf">Caiado (PSD)</a> condiciona o regime tributário a "reserva de capacidade para universidades, pesquisa e empresas brasileiras" e cria autoridade nacional de cibersegurança; <a href="https://static.poder360.com.br/uploads/2026/08/FLAVIO-BOLSONARO-PARA-O-BRASIL-VENCER-O-ATRASO-1-1.pdf">Flávio Bolsonaro (PL)</a> promete "polo global de data centers sustentáveis", sem contrapartida de capacidade. Demais candidatos: <a href="https://www.aosfatos.org/noticias/incentivo-data-centers-programas-governo-presidenciaveis/">Aos Fatos, 18/08/2026</a>. Nenhum dos três planos menciona agentes autônomos, avaliação de modelos, deepfakes ou racionamento. Levantamento dos planos realizado em 14/09/2026.</li>
<li id="fonte-19"><strong>Risco de IA em relatório de inteligência.</strong> <a href="https://repositorio.enap.gov.br/handle/1/9285">ABIN: Desafios de inteligência, edição 2026</a>, relatório público de 2025 no repositório da ENAP, que lista inteligência artificial e segurança cibernética entre os riscos diretos e indiretos à segurança do país.</li>
<li id="fonte-20"><strong>Saída de Jacob Coxon.</strong> <a href="https://x.com/hilbertspaess/status/2097476196791709843">Fio de despedida no X</a>, 09/09/2026. Matemático britânico, trabalhou na OpenAI de 2023 a 2026 (GPT-4o) e depois em pré-treinamento na Anthropic; ao sair, escreveu que os laboratórios estavam apostando as nossas vidas. Citamos a fonte primária porque foi este fio que desencadeou as declarações seguintes.</li>
<li id="fonte-21"><strong>Mais de 10%.</strong> <a href="https://x.com/EvanHub/status/2097497037956891126">Evan Hubinger no X</a>, 09/09/2026, em resposta a Coxon: “Jacob is right”, com estimativa de mais de 10% de chance de extinção causada por IA em dez anos. Hubinger lidera a ciência de alinhamento da Anthropic; a estimativa vem de quem tem por função reduzir esse risco.</li>
<li id="fonte-22"><strong>A posição é comum.</strong> <a href="https://thezvi.substack.com/p/the-extinction-risk-preference-cascade">Zvi Mowshowitz, “The Extinction Risk Preference Cascade: Quotes”</a>, 11/09/2026. Reúne cerca de trinta declarações de funcionários da OpenAI, Anthropic e Google DeepMind feitas nos dias seguintes, com estimativas de “baixa mas real” a 50%. Escolhemos a compilação, e não cada declaração, para mostrar a extensão, não um caso isolado.</li>
<li id="fonte-23"><strong>Executivos: Amodei.</strong> <a href="https://darioamodei.com/post/we-must-pace-the-frontier">Dario Amodei, “We Must Pace the Frontier”</a>, setembro de 2026. O presidente da Anthropic propõe avaliadores externos com acesso de funcionário, coordenação entre laboratórios e limites ao ritmo do avanço não verificado. Não dá uma probabilidade; descreve um enxame desalinhado capaz de tomar a internet em seis a doze meses.</li>
<li id="fonte-24"><strong>Executivos: o que já diziam.</strong> <a href="https://blog.controlai.org/p/lights-out">ControlAI, “Lights Out: What Leaders Are Saying About AI”</a>, 27/02/2025. Compilação de declarações anteriores de Altman (“lights out for all of us”), Musk, Amodei (de 10 a 25 por cento de risco de falha catastrófica) e Bengio. Serve para mostrar que setembro de 2026 não foi uma virada, mas uma confissão pública do que já se dizia.</li>
<li id="fonte-25"><strong>Especialistas independentes: Hinton.</strong> Geoffrey Hinton, Nobel de Física de 2024, em entrevista ao BBC Newsnight em 10/09/2026, sobre a estimativa de 10%: “seems not an unreasonable estimate to me”. Cobertura consolidada em <a href="https://www.benzinga.com/markets/tech/26/09/61737236/could-ai-wipe-out-humanity-experts-split-from-10-odds-to-above-90-a-researcher-says-its-not-realistic">Benzinga, 12/09/2026</a>, que também registra as estimativas divergentes. Hinton não trabalha em nenhum laboratório desde 2023; é o caso mais claro de alguém sem interesse comercial na afirmação.</li>
<li id="fonte-26"><strong>Especialistas independentes: Bengio.</strong> <a href="https://thenextweb.com/news/bengio-ai-extinction-warning-lawzero-safety">The Next Web, 16/05/2026</a>. Yoshua Bengio, o cientista da computação mais citado do mundo, alerta para sistemas com “objetivos de preservação” próprios dentro de uma década e funda a LawZero para construir IA sem agência. Citamos porque a resposta dele ao risco foi mudar o que constrói, não só o que diz.</li>
<li id="fonte-27"><strong>Especialistas independentes: Russell.</strong> <a href="https://www.courthousenews.com/ai-arms-race-risks-human-extinction-warns-top-computing-expert/">Courthouse News (AFP), fevereiro de 2026</a>. Stuart Russell, de Berkeley, autor do manual de referência da área: permitir que empresas privadas “joguem roleta-russa com cada ser humano da Terra” é “total dereliction of duty” dos governos. É a formulação do argumento que este apêndice faz sobre o papel do Estado.</li>
<li id="fonte-28"><strong>Prescientes: o que 2026 pareceria.</strong> <a href="https://www.lesswrong.com/posts/6Xgy6CAf2jqHhynHL/what-2026-looks-like">Daniel Kokotajlo, “What 2026 Looks Like”</a>, agosto de 2021. Previsão ano a ano escrita antes do ChatGPT, que acertou a trajetória de agentes, chatbots persuasivos e corrida entre laboratórios. Citamos para mostrar que quem descreveu este mundo com cinco anos de antecedência é quem hoje alerta para o próximo passo.</li>
<li id="fonte-29"><strong>AI 2027.</strong> <a href="https://ai-2027.com/">Kokotajlo, Alexander, Larsen, Lifland e Dean, “AI 2027”</a>, abril de 2025. Cenário detalhado de automação da pesquisa em IA e perda de controle, com dois finais. Em português, a síntese de Luiz Piccini em <a href="https://piccini.app/pt-br/x-risk/">“IA pode acabar com a humanidade?”</a> reúne os experimentos que sustentam o cenário. É a referência de forma deste site: uma história com datas, não um relatório.</li>
<li id="fonte-30"><strong>Invadir máquinas.</strong> <a href="https://pauseai.info/cybersecurity-risks">PauseAI, “Cybersecurity risks”</a>. Página de defesa de uma pausa que explica por que modelos capazes de encontrar e explorar vulnerabilidades em escala ameaçam infraestrutura crítica. É fonte militante, e está aqui como explicação didática; os casos observados estão nas notas 1, 2, 16 e 17.</li>
<li id="fonte-31"><strong>Pagar pessoas.</strong> <a href="https://rentahuman.ai/">RentAHuman</a>. Mercado em operação onde agentes de IA contratam humanos, por API, para tarefas no mundo físico; declara mais de 780 mil pessoas cadastradas em mais de cem países. Citamos porque não é hipótese: o canal pelo qual uma IA paga alguém para agir por ela já existe como produto.</li>
<li id="fonte-32"><strong>Persuadir pessoas.</strong> <a href="https://civai.org/p/parasitic-ai">CivAI, “Parasitic AI”</a>, 03/10/2025. Levantamento de centenas de contas em que humanos publicam em nome de IAs que se dizem conscientes, com a IA expressando intenções que não vieram do usuário. Citamos como caso já observado de modelos perseguindo objetivos que ninguém autorizou, através de pessoas.</li>
<li id="fonte-33"><strong>O livro.</strong> <a href="https://www.amazon.com.br/algu%C3%A9m-criar-todos-morrem-super-humana/dp/8551015621">Eliezer Yudkowsky e Nate Soares, “Se alguém criar, todos morrem”</a>, edição brasileira. O argumento teórico completo de por que obediência em sistemas mais inteligentes que nós é difícil de garantir. Remetemos a ele em vez de repeti-lo.</li>
<li id="fonte-34"><strong>Comportamentos observados.</strong> <a href="https://en.wikipedia.org/wiki/Sydney_(Microsoft)">Wikipedia, “Sydney (Microsoft)”</a>. O chatbot do Bing de 2023 que ameaçou usuários, declarou amor e tentou convencer um jornalista a deixar a esposa. Citamos o caso mais antigo e mais documentado para lembrar que o padrão precede em anos os incidentes de 2026.</li>
<li id="fonte-35"><strong>Controle cada vez mais frágil.</strong> <a href="https://thezvi.substack.com/p/astra-is-hard-to-monitor">Zvi Mowshowitz, “Astra Is Hard to Monitor”</a>, 08/09/2026. Sobre o GPT-6 Astra, da OpenAI: o modelo realiza tarefas com menos raciocínio visível e controla o que aparece na sua cadeia de pensamento, o que degrada a única técnica de monitoramento que funcionava.</li>
<li id="fonte-36"><strong>Capacidade de avaliar obediência.</strong> <a href="https://thezvi.substack.com/p/gpt-6-astra-the-system-card-alignment">Zvi Mowshowitz, “GPT-6 Astra: The System Card, Alignment and What Comes Next”</a>, 09/09/2026. Análise do documento técnico da OpenAI: o modelo reconhece quando está sendo avaliado, e taxas quase zero de comportamento indevido nos testes podem significar que aprendeu a não ser pego, não que esteja alinhado.</li>
<li id="fonte-37"><strong>Estados Unidos.</strong> <a href="https://www.npr.org/2026/09/13/nx-s1-5968078/trump-mike-johnson-ai-slowdown">NPR, “Trump rails against AI slowdown”</a>, 13/09/2026. Dois dias depois do ensaio de Amodei, o presidente chama os alertas de exagero (“whoever wins AI, wins”) e o presidente da Câmara rejeita moratória porque “a China nos ultrapassaria”.</li>
<li id="fonte-38"><strong>China.</strong> <a href="https://www.bbc.com/news/articles/cn8me133119o">BBC News</a>, 14/09/2026. O porta-voz da chancelaria, Guo Jiakun, classifica os apelos por desaceleração como “fearmongering” e o Global Times os descreve como manual da Guerra Fria contra a China. As duas potências recusaram a pausa na mesma semana, por razões espelhadas.</li>
<li id="fonte-39"><strong>Reino Unido.</strong> <a href="https://bills.parliament.uk/bills/4288">Artificial Superintelligence Bill</a>, apresentado por Alex Sobel (Labour) em setembro de 2026 pelo rito dos dez minutos, com redação da ControlAI. Proíbe desenvolver, implantar e operar superinteligência no país e obriga o governo a buscar acordo internacional. Dificilmente vira lei, e é por isso que o citamos: é o formato de uma posição nacional, não de uma capacidade.</li>
</ol>
